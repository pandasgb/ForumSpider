...
def run(kww):
    ...
    df.to_csv('C:/Users/Administrator/Desktop/huaweiForum-'+keywords+'.csv',encoding='utf-8-sig',index=False)


def get_keywordUrl(srchtxt):
    srchtxt = srchtxt
    initUrl = 'https://club.huawei.com/search.php?mod=forum'
    ...
    keywordUrl = 'https://club.huawei.com/' + keywordUrl
    print('keywordUrl=', keywordUrl+str(1))
    return keywordUrl
...
def get_comment(keywordUrl):
    ...
    while 1:
        ...
        for tie in tieList:
            tid = tie.xpath('./@id')[0]
            tidurl = 'https://club.huawei.com/thread-'+str(tid)+'-1-1.html'
