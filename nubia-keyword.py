...
def run(kww):
    ...
    df.to_csv('C:/Users/Administrator/Desktop/nubiaForum-'+keywords+'.csv',encoding='utf-8-sig',index=False)


def get_keywordUrl(srchtxt):
    srchtxt = srchtxt
    initUrl = 'https://bbs.nubia.cn/search.php?mod=forum'
    ...
    keywordUrl = 'https://bbs.nubia.cn/'+keywordUrl
    print('keywordUrl=', keywordUrl)
    return keywordUrl
...
def get_comment(keywordUrl):
    ...
    while 1:
        ...
        for tie in tieList:
            tid = tie.xpath('./@id')[0]
            tidurl = 'https://bbs.nubia.cn/forum.php?mod=viewthread&tid=' + str(tid)
